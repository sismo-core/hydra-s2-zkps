...
describe("Hydra S2 Prover", () => {
  ...
  it("Should throw with Invalid Accounts Merkle tree height", async () => {
    ...
    const prover2 = new HydraS2Prover(await commitmentMapperTester.getPubKey());
  ...
  it("Should throw with invalid Registry tree height", async () => {
    ...
    const prover3 = new HydraS2Prover(await commitmentMapperTester.getPubKey());
